...
public class CustomListAdapter extends ArrayAdapter {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if(rowView == null){
            ...
            CustomListAdapterFirebase.ViewHolder viewHolder = new CustomListAdapterFirebase.ViewHolder();
        ...
        final CustomListAdapterFirebase.ViewHolder holder = (CustomListAdapterFirebase.ViewHolder) rowView.getTag();
